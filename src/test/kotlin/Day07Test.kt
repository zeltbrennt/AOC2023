...
class Day07Test {
    ...
    fun four_of_a_kind() {
        ...
        assertEquals(HandType.FIVE_OF_A_KIND, hand.handType)
    }

    @Test
    @DisplayName("AA8AA isfour of a kind")
    fun five_of_a_kind() {
        val hand = "AA8AA".toHand()
        assertEquals(HandType.FOUR_OF_A_KIND, hand.handType)
    }
    ...
    fun three_of_a_kind() {
        ...
        assertEquals(HandType.THREE_OF_A_KIND, hand.handType)
    }
    ...
    fun full_house() {
        ...
        assertEquals(HandType.FULL_HOUSE, hand.handType)
    }
    ...
    fun two_pair() {
        ...
        assertEquals(HandType.TWO_PAIR, hand.handType)
    }
    ...
    fun one_pair() {
        ...
        assertEquals(HandType.ONE_PAIR, hand.handType)
    }
    ...
    fun high_card() {
        ...
        assertEquals(HandType.HIGH_CARD, hand.handType)
    }
